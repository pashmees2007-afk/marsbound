...
export const segmentationAnalyses = mysqlTable("segmentation_analyses", {
  id: int("id").autoincrement().primaryKey(),
  analysisId: varchar("analysisId", { length: 64 }).notNull().unique(),
  userOpenId: varchar("userOpenId", { length: 64 }),
  sourceUrl: text("sourceUrl").notNull(),
  predictionUrl: text("predictionUrl").notNull(),
...
export type InsertSegmentationAnalysis = typeof segmentationAnalyses.$inferInsert;
